...
% Load data
try
    load('/tudelft.net/staff-bulk/ewi/insy/PRLab/Staff/wmkouw/flda-imdb/da_imdb6.mat');
catch
    load('da_imdb6.mat');
end
...
if any(strcmp(clf, {'tlr','tqd'}));
    ...
    for d = 1:lD
        ...
        yX = y(ixX);
        [W{d},Theta{d},err(d),mis{d},lambda(d)] = da_xval(clf, X,yX,X,yX,'nR', nR, 'nF', nF, 'l2', l2, 'nE', nE,'mu',mu,'Kt',Kt,'Kp',Kp,'Ga',Ga,'La',La);
    end
    ...
    for cc = 1:lCmb;
        ...
        [W{cc},Theta{cc}, err(cc), mis{cc}, lambda(cc)] = da_xval(clf,X,yX,Z,yZ,'nR', nR, 'nF', nF, 'l2', l2, 'nE', nE,'mu',mu,'Kt',Kt,'Kp',Kp,'Ga',Ga,'La',La);
        
    end
end

% Write results
fname = ['daexp_imdb_xval_'  clf '_' prep{:} '.mat'];
