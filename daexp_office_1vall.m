function [serr,terr,W,theta] = daexp_office_1vall(loss,transfer,prep)
% Function to run some da experiments on the office_da dataset with surf
% features
...
for cc = 1:lCmb;
    ...
    fname = ['daexp_office_surf_'  loss '_' transfer '_' prep{:} '_' ...
