...
% Function to run a feature-level domain adaptive classifier using a logistic loss and a blankout transfer distribution.
...
if K==2
    ...
    % Currently still a one-vs-all multiclass scheme
