function [serr,terr,W,Theta] = daexp_amazon(loss,transfer,prep)
...
% Load data
try
%     load('/home/nfs/wkouw/amazonR5.mat')
    load('/home/nfs/wkouw/amazon.mat');    
catch
%     load('/home/wmkouw/Data/Amazon/amazonR5.mat');
...
for cc = 1:lCmb;
    ...
    fname = ['daexp_amazon_'  loss '_' transfer '_' prep{:} '_' ...
